...
public class EmployeeController {
    public void printEmpInformation(Employee emp)
    {
        if(emp.getStatus() == 0)
        {
            System.out.println("Nhân viên đã nghỉ việc hoặc không tồn tại.");
        }
    ...
    public Employee getEmployeeInfor()
    {
       Scanner sc = new Scanner(System.in);
        ...
        System.out.println("Vui lòng nhập số giờ đã làm việc: ");
        ...
        Employee emp = new Employee(name, email, phone, workingHours, salaryPerHour);
        emp.setStatus(1);
        return emp;
    }
}
